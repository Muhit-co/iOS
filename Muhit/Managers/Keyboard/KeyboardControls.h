...
@interface KeyboardControls : UIView <UIInputViewAudioFeedback>

/**
 *  Delegate to send callbacks to.
 */
@property (nonatomic, weak) id <KeyboardControlsDelegate> delegate;

/**
 *  Visible controls. Use a bitmask to show multiple controls.
 */
@property (nonatomic, assign) KeyboardControl visibleControls;
